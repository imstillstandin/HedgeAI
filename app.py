...
from fx_radar.risk_engine import add_scenarios, calculate_health_score, classify_urgency, scenario_analysis
...
st.caption("Upload FX exposures, run risk analysis, and review deterministic hedge policy decisions.")
...
st.write(
    ...
    "using your business and market inputs. It supports decision-making and does not predict market direction."
)
